...
class Header extends HTMLElement {
  ...
  async connectedCallback() {
    this.innerHTML = `
        <style>
            ${await load("./components/css/header.css")}
        </style>
        `;
    this.innerHTML += await load("./components/header.html");
...
class Footer extends HTMLElement {
  ...
  async connectedCallback() {
    this.innerHTML = `
        <style>
            ${await load("./components/css/footer.css")}
        </style>
        `;
    this.innerHTML += await load("./components/footer.html");
  }
}
...
class Newsletter extends HTMLElement {
  ...
  async connectedCallback() {
    this.innerHTML = `
        <style>
            ${await load("./components/css/newsletter.css")}
        </style>
        `;
    this.innerHTML += await load("./components/newsletter.html");
  }
}
